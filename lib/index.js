...
var Store = /** @class */ (function () {
    ...
    function Store(initialState) {
         ...
         */
        this.resolveState = function (cb) { return __awaiter(_this, void 0, void 0, function () {
            var newState;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cb(this.getState)
                        // update the state
                    ];
                    case 1:
                        newState = _a.sent();
                        ...
                        return [4 /*yield*/, Promise.all(this.subscribers.map(function (subscriber) { return subscriber(_this.state); }))];
                    case 2:
                        // call the subscribers
                        _a.sent();
