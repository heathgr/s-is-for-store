...
var Store = /** @class */ (function () {
    ...
    function Store(initialState) {
         ...
         */
        this.setState = function (newState) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(this.subscribers.map(function (subsciber) { return subsciber(_this.state); }))];
                    case 1:
                        // call the subscribers
                        _a.sent();
